...
tags: ["app", "ios", "play-to-earn", "rewards", "community", "awareness"]
type: "news"
---
...
![BTCZ Awareness App](/images/news/btcz-awareness-app/btcz-awareness-app-hero.jpeg)

## Key Features

- **Quiz Challenges** — Test your knowledge about BitcoinZ and cryptocurrency with interactive quizzes. The more you know, the more you earn.

- **Daily Login Rewards** — Simply open the app every day to collect bonus rewards. Consistency pays off.

- **Fun Fact Shares** — Discover interesting facts about BitcoinZ and share them with your network to earn additional rewards.

- **Social Tasks** — Complete community-driven social media tasks to boost awareness and earn BTCZ at the same time.

- **Rewarded Videos** — Watch short video content and get rewarded for your time. A simple way to accumulate BTCZ while staying informed.

- **PVP Games** — Challenge your friends and other players in competitive player-versus-player games. Prove your skills and win BTCZ.

- **In-App Purchases** — Unlock premium features and power-ups to enhance your experience within the app.

- **Claim Rewards** — Accumulated BTCZ rewards can be claimed and sent directly to your personal BitcoinZ wallet. Your earnings, your coins.
...
Download the app, spread the word, and start earning. The BitcoinZ community is growing — and now there's an app for that.
